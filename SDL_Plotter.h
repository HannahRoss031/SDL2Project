...
public:
    ...
    void drawCharacter(int x, int y, char letter, int r, int g, int b, int scale); 
    void drawString(int x, int y, const char* text, int r, int g, int b, int scale); 
    
    //added
       SDL_Renderer* getRenderer() {
            return renderer;
        }
        void plotPixel(int x, int y, Uint8 r, Uint8 g, Uint8 b) {
